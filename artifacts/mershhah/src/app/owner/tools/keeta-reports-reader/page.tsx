  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="ارفع ملف التقرير اللي تصدّره من لوحة تحكم كيتا للتجار، ونطلع لك ملخص واضح بالأرقام."
      />
        ...
        >
          {isParsing ? (
            ...
            <>
              ...
              <p className="text-sm font-bold text-gray-700">ارفع ملف تقرير كيتا</p>
