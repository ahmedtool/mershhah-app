...
import { MenuPageToolbar } from '@/components/dashboard/MenuPageToolbar';
import { Flame, Utensils, DollarSign, TrendingUp, Package } from 'lucide-react';
