      ...
      <main className="py-16 sm:py-24 px-4">
        ...
        <div className="max-w-4xl mx-auto grid sm:grid-cols-2 gap-4 mb-20">
          <div className="bg-white border border-gray-100 rounded-2xl p-6">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">أن نكون الشريك التقني الأول لكل مطعم ومقهى في الشرق الأوسط، ونساهم في نموهم من خلال حلول ذكية ومبتكرة.</p>
          </div>
          <div className="bg-white border border-gray-100 rounded-2xl p-6">
            <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center mb-4">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">توفير منصة سهلة الاستخدام وقوية تدمج بين الذكاء الاصطناعي وأدوات التسويق لمساعدة المشاريع على بناء علاقات أعمق مع عملائها.</p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-xs text-gray-600">المبادئ التي توجه كل قرار نتخذه.</p>
          </div>
            ...
            {values.map((v, i) => (
              <div key={i} className="bg-white border border-gray-100 rounded-2xl p-6 text-center">
                <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center mx-auto mb-4">
                  <v.icon className="h-5 w-5 text-gray-600" />
                </div>
        ...
        <div className="text-center mt-20">
          <p className="text-sm text-gray-600 mb-4">سجّل واحصل على واجهتك الرقمية.</p>
