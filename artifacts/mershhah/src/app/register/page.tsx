    ...
    <div className="min-h-screen flex" dir="rtl">
      ...
      <div className="flex-1 flex items-center justify-center px-6 bg-white">
        <div className="w-full max-w-sm">
          ...
          {/* Title */}
          <div className="mb-8">
            <h1 className="text-2xl font-black text-gray-900 mb-2">أنشئ حسابك</h1>
            <p className="text-sm text-gray-400">سجّل بياناتك للانضمام إلى المنصة</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              <p className="text-sm text-gray-500">عندك حساب بالفعل؟</p>
              <Link href="/login" className="inline-block mt-2 text-sm font-bold text-gray-900 hover:underline">
                سجّل دخولك
              </Link>
            </div>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gray-900 items-center justify-center p-12">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            انضم إلى مئات المطاعم والمقاهي التي تستخدم مرشح لإدارة أعمالها بكفاءة.
          </p>
