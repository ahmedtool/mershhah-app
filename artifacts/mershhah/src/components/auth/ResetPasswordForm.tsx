...
export function ResetPasswordForm() {
  ...
  if (isSuccess) {
    return (
      <div className="text-center py-4">
        ...
        <p className="text-xs text-gray-600">جاري تحويلك لصفحة تسجيل الدخول...</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
      <div>
        <label className="text-[11px] font-bold text-gray-600 mb-1.5 block">كلمة المرور الجديدة</label>
        <input
          type="password"
          placeholder="••••••••"
      ...
      <div>
        <label className="text-[11px] font-bold text-gray-600 mb-1.5 block">تأكيد كلمة المرور</label>
        <input
          type="password"
          placeholder="••••••••"
